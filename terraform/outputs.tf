...
locals {
  mainconfig_yaml = templatefile("${path.module}/../../mainconfig.yaml", {
    project_id    = var.project_config.project_id, #module.mlops.github.PROJECT_ID,
    region        = var.region,
    ...
    docker_repo   = "europe-west2-docker.pkg.dev/fsa-sandbox/mlops-docker-repo", #module.mlops.github.DOCKER_REPO,
    sa_mlops      = "mlops-vertexai-sa@fsa-sandbox.iam.gserviceaccount.com", #module.mlops.github.SA_MLOPS,
    subnetwork    = "vpc-default" #module.mlops.github.SUBNETWORK
  })

  gh_containers_yaml = templatefile("${path.module}/../../.github/workflows/containers.yml", {
    wip         = "projects/145265810255/locations/global/workloadIdentityPools/github-actions/providers/github-actions-provider", #module.mlops.github.WORKLOAD_ID_PROVIDER,
    project_id  = var.project_config.project_id, #module.mlops.github.PROJECT_ID,
    sa          = "service-145265810255@gcp-sa-cloudbuild.iam.gserviceaccount.com", #module.mlops.github.SERVICE_ACCOUNT,
    docker_repo = "europe-west2-docker.pkg.dev/fsa-sandbox/mlops-docker-repo", #module.mlops.github.DOCKER_REPO
    environment = var.environment
  })

  gh_main_tfx_yaml = templatefile("${path.module}/../../.github/workflows/main.yml", {
    wip         = "projects/145265810255/locations/global/workloadIdentityPools/github-actions/providers/github-actions-provider", #module.mlops.github.WORKLOAD_ID_PROVIDER,
    project_id  = var.project_config.project_id, #module.mlops.github.PROJECT_ID,
    sa          = "service-145265810255@gcp-sa-cloudbuild.iam.gserviceaccount.com", #module.mlops.github.SERVICE_ACCOUNT,
    docker_repo = "europe-west2-docker.pkg.dev/fsa-sandbox/mlops-docker-repo", #module.mlops.github.DOCKER_REPO,
  ...
  gh_main_kfp_yaml = templatefile("${path.module}/../../.github/workflows/main.yml", {
    wip         = "projects/145265810255/locations/global/workloadIdentityPools/github-actions/providers/github-actions-provider", #module.mlops.github.WORKLOAD_ID_PROVIDER,
    project_id  = var.project_config.project_id, #module.mlops.github.PROJECT_ID,
    sa          = "service-145265810255@gcp-sa-cloudbuild.iam.gserviceaccount.com", #module.mlops.github.SERVICE_ACCOUNT,
    docker_repo = "europe-west2-docker.pkg.dev/fsa-sandbox/mlops-docker-repo", #module.mlops.github.DOCKER_REPO,
  ...
  gh_main_bqml_yaml = templatefile("${path.module}/../../.github/workflows/main.yml", {
    wip         = "projects/145265810255/locations/global/workloadIdentityPools/github-actions/providers/github-actions-provider", #module.mlops.github.WORKLOAD_ID_PROVIDER,
    project_id  = var.project_config.project_id, #module.mlops.github.PROJECT_ID,
    sa          = "service-145265810255@gcp-sa-cloudbuild.iam.gserviceaccount.com", #module.mlops.github.SERVICE_ACCOUNT,
    docker_repo = "europe-west2-docker.pkg.dev/fsa-sandbox/mlops-docker-repo", #module.mlops.github.DOCKER_REPO,
  ...
  gh_run_tfx_yaml = templatefile("${path.module}/../../.github/workflows/run.yml", {
    wip         = "projects/145265810255/locations/global/workloadIdentityPools/github-actions/providers/github-actions-provider", #module.mlops.github.WORKLOAD_ID_PROVIDER,
    project_id  = var.project_config.project_id, #module.mlops.github.PROJECT_ID,
    sa          = "service-145265810255@gcp-sa-cloudbuild.iam.gserviceaccount.com", #module.mlops.github.SERVICE_ACCOUNT,
    docker_repo = "europe-west2-docker.pkg.dev/fsa-sandbox/mlops-docker-repo", #module.mlops.github.DOCKER_REPO,
  ...
  gh_run_kfp_yaml = templatefile("${path.module}/../../.github/workflows/run.yml", {
    wip         = "projects/145265810255/locations/global/workloadIdentityPools/github-actions/providers/github-actions-provider", #module.mlops.github.WORKLOAD_ID_PROVIDER,
    project_id  = var.project_config.project_id, #module.mlops.github.PROJECT_ID,
    sa          = "service-145265810255@gcp-sa-cloudbuild.iam.gserviceaccount.com", #module.mlops.github.SERVICE_ACCOUNT,
    docker_repo = "europe-west2-docker.pkg.dev/fsa-sandbox/mlops-docker-repo", #module.mlops.github.DOCKER_REPO,
  ...
  gh_run_bqml_yaml = templatefile("${path.module}/../../.github/workflows/run.yml", {
    wip         = "projects/145265810255/locations/global/workloadIdentityPools/github-actions/providers/github-actions-provider", #module.mlops.github.WORKLOAD_ID_PROVIDER,
    project_id  = var.project_config.project_id, #module.mlops.github.PROJECT_ID,
    sa          = "service-145265810255@gcp-sa-cloudbuild.iam.gserviceaccount.com", #module.mlops.github.SERVICE_ACCOUNT,
    docker_repo = "europe-west2-docker.pkg.dev/fsa-sandbox/mlops-docker-repo", #module.mlops.github.DOCKER_REPO,
  ...
  gh_deploy_yaml = templatefile("${path.module}/../../.github/workflows/deploy.yml", {
    wip         = "projects/145265810255/locations/global/workloadIdentityPools/github-actions/providers/github-actions-provider", #module.mlops.github.WORKLOAD_ID_PROVIDER,
    project_id  = var.project_config.project_id, #module.mlops.github.PROJECT_ID,
    sa          = "service-145265810255@gcp-sa-cloudbuild.iam.gserviceaccount.com", #module.mlops.github.SERVICE_ACCOUNT,
    docker_repo = "europe-west2-docker.pkg.dev/fsa-sandbox/mlops-docker-repo", #module.mlops.github.DOCKER_REPO,
  ...
  pipeline_deploy_tfx = templatefile("${path.module}/../../build/pipeline-deployment-tfx.yaml", {
    project_id    = var.project_config.project_id, #module.mlops.github.PROJECT_ID,
    region        = var.region,
    github_org    = try(var.github.organization, null),
    github_repo   = try(var.github.repo, null),
    ...
    sa_mlops      = "mlops-vertexai-sa@fsa-sandbox.iam.gserviceaccount.com", #module.mlops.github.SA_MLOPS,
    subnetwork    = "vpc-default" #module.mlops.github.SUBNETWORK,
    bucket_name   = "mlops-vertex-ai-${var.environment}" #"${var.prefix}-${var.bucket_name}-${var.environment}"
  })

  pipeline_deploy_kfp = templatefile("${path.module}/../../build/pipeline-deployment-kfp.yaml", {
    project_id    = var.project_config.project_id, #module.mlops.github.PROJECT_ID,
    region        = var.region,
    github_org    = try(var.github.organization, null),
    github_repo   = try(var.github.repo, null),
    ...
    docker_repo   = "europe-west2-docker.pkg.dev/fsa-sandbox/mlops-docker-repo", #module.mlops.github.DOCKER_REPO,
    sa_mlops      = "mlops-vertexai-sa@fsa-sandbox.iam.gserviceaccount.com", #module.mlops.github.SA_MLOPS,
    dataflow_network = "regions/europe-west2/subnetworks/vpc-default",
    subnetwork    = "vpc-default" #module.mlops.github.SUBNETWORK,
    bucket_name   = "${var.bucket_name}-${var.environment}" #"${var.prefix}-${var.bucket_name}-${var.environment}"
  })

  pipeline_deploy_bqml = templatefile("${path.module}/../../build/pipeline-deployment-bqml.yaml", {
    project_id    = var.project_config.project_id, #module.mlops.github.PROJECT_ID,
    region        = var.region,
    github_org    = try(var.github.organization, null),
    github_repo   = try(var.github.repo, null),
  ...
  pipeline_run_tfx = templatefile("${path.module}/../../build/pipeline-run.yaml", {
    project_id    = var.project_config.project_id, #module.mlops.github.PROJECT_ID,
    region        = var.region,
    github_org    = try(var.github.organization, null),
    github_repo   = try(var.github.repo, null),
  ...
  pipeline_run_kfp = templatefile("${path.module}/../../build/pipeline-run.yaml", {
    project_id    = "${var.project_config.project_id}", #module.mlops.github.PROJECT_ID,
    region        = var.region,
    github_org    = try(var.github.organization, null),
    github_repo   = try(var.github.repo, null),
    ...
    pipeline_params = "{\"bq_table\": \"${var.project_config.project_id}.${var.dataset_name}.creditcards_ml\", \"xgboost_param_max_depth\": 5, \"xgboost_param_learning_rate\": 0.1, \"xgboost_param_n_estimators\": 20}"
  })
  
  pipeline_run_bqml = templatefile("${path.module}/../../build/pipeline-run.yaml", {
    project_id    = var.project_config.project_id, #module.mlops.github.PROJECT_ID,
    region        = var.region,
    github_org    = try(var.github.organization, null),
    github_repo   = try(var.github.repo, null),
    ...
    pipeline_params = "{\"bq_table\": \"${var.project_config.project_id}.${var.dataset_name}.creditcards_ml\"}"
  })

  model_deployment = templatefile("${path.module}/../../build/model-deployment-tfx.yaml", {
    project_id    = var.project_config.project_id, #module.mlops.github.PROJECT_ID,
    region        = var.region,
    github_org    = try(var.github.organization, null),
    github_repo   = try(var.github.repo, null),
